...
check('release version is 3.20.8', version === '3.20.8' && pkg.version === '3.20.8');
...
check('RPT-1.3 changelog entry exists', changelog.startsWith('## 3.20.8 — RPT-1.3 Agent Workspace Customer Report Recovery'));
