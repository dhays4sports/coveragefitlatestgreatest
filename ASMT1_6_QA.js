...
check('release version is ASMT-1.6', ['3.20.6','3.20.7','3.20.8'].includes(version));
check('package version is ASMT-1.6', ['3.20.6','3.20.7','3.20.8'].includes(JSON.parse(read('package.json')).version));
